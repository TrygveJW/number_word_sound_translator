...
The reason for this existing is that this reverse mapping is highly useful with certain memory technique.


todo: mabye use the word frequensy as sorting order
